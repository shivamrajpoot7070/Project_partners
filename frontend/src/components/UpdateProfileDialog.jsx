...
//         bio: user?.profile?.bio || "",
//         skills: user?.profile?.skills?.map(skill => skill) || "",
//         file: user?.profile?.resume || ""  // This will store the Google Drive link
//     });
//     const dispatch = useDispatch();
...
//         // Send the Google Drive link instead of the file itself
//         if (input.file) {
//             formData.append("file", input.file); // Google Drive link is passed here
//         }
